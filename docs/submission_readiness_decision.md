...
Honest strongest claim: `Handle goals that become physically or perceptually unavailable during execution.` is a plausible branch-structured mechanism for partially observable manipulation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
